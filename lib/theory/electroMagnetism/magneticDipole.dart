...
\begin{aligned}
&\vec B(\vec r)\\[6pt]
\fallingdotseq &\frac{q_m}{4\pi r^3} \Biggl( - { \vec d}+\frac{3(\vec r\cdot\vec d)\vec r}{r^2}\Biggr)+O\!\Bigl(\frac{|\vec d|^3}{r^5}\Bigr)\\[5pt]
\fallingdotseq &\frac{q_m}{4\pi r^3} \Biggl( - { \vec d}+3 \frac{\vec r}{r} \cdot\vec d \frac{\vec r}{r} \Biggr)+O\!\Bigl(\frac{|\vec d|^3}{r^5}\Bigr)\\[5pt]
\fallingdotseq &\frac{\mu_0}{4\pi r^3} \Biggl( - \frac{q_m \vec d}{\mu_0}+3 \frac{\vec r}{r} \cdot \frac{q_m \vec d}{\mu_0} \frac{\vec r}{r} \Biggr)+O\!\Bigl(\frac{|\vec d|^3}{r^5}\Bigr)\\[5pt]
...
= -R^2\sin\theta\cos\theta B_z(\hat{j}\times\hat{i})\\[4pt]
...
\displaystyle &(R\sin\theta\hat{j})\times\bigl((R\sin\theta B_y - R\cos\theta B_x)\hat{k}\bigr)\\[4pt]
&\qquad=R^2\sin\theta\bigl(\sin\theta B_y - \cos\theta B_x\bigr)(\hat{j}\times\hat{k})\\[4pt]
...
\begin{aligned}
& \vec m = \displaystyle \pi a^2 I\hat{z}\\[5pt]
\Leftrightarrow & \hat{z} = \vec m \displaystyle \frac{I}{\pi a^2}
\end{aligned}
を用いると、
\begin{aligned}
&\ \displaystyle \pi a^2\big(3\hat{r}(\hat{r}\cdot\hat{z})-\hat{z}\big)\\[5pt]
...
\begin{aligned}
\vec B(\vec r)=&\frac{\mu_0}{4\pi r^3}\Bigl(-\frac{q_m\vec a}{\mu_0} + 3(\frac{q_m\vec a}{\mu_0} \cdot \hat r)\hat r\Bigr)\\[5pt]
=&\frac{\mu_0}{4\pi r^3}\Bigl(-\frac{q_m a \hat{z}}{\mu_0} + 3(\frac{q_m a \hat{z}}{\mu_0} \cdot \hat r)\hat r\Bigr)\\[5pt]
\end{aligned}
