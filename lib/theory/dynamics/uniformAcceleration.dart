...
\\begin{aligned}
v' &= a \\quad \\quad \\\\[5pt]
\\Leftrightarrow \\int_{0}^{t} v' \\, dt &= \\int_{0}^{t} a \\, dt \\\\[5pt]
\\Leftrightarrow v(t) - v_0 &= a t \\\\[5pt]
...
\\begin{aligned}
x' &= v \\quad  \\quad \\\\[5pt]
\\Leftrightarrow \\int_{0}^{t} x' \\, dt &= \\int_{0}^{t} (v_0 + a t) \\, dt \\\\[5pt]
\\Leftrightarrow x(t) - x_0 &= v_0 t + \\frac{1}{2} a t^2 \\\\[5pt]
...
\\begin{aligned}
x - x_0 &= v_0\\frac{v-v_0}{a} + \\frac{1}{2}a \\left(\\frac{v-v_0}{a}\\right)^2 \\\\[5pt]
\\Leftrightarrow x - x_0 &= \\frac{v_0(v-v_0)}{a} + \\frac{1}{2a}(v-v_0)^2 \\\\[5pt]
\\Leftrightarrow a(x-x_0) &= v_0(v-v_0) +\\frac{1}{2}(v-v_0)^2 \\\\[5pt]
\\Leftrightarrow v^2 &= v_0^2 + 2a(x-x_0)\\\\[5pt]
\\Leftrightarrow v^2 - v_0^2 &= 2a(x-x_0)\\\\[5pt]
\\end{aligned}
\\(\\square\\)
